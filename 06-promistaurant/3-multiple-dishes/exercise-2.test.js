    ...
    .then(([lindasMeal, monicasMeal, ninasMeal, oliviasMeal]) => {
        ...
        describe("Monica's meal", () => {
            ...
            describe('the meal should have 1 extras', () => {
                ...
                it('includes: pineapple', () => {
                    expect(
                        monicasMeal.extras.includes(extras.pineapple),
                    ).toEqual(true);
                });
            });
        });
        ...
        describe("Olivia's meal", () => {
            ...
            describe('the meal should have 4 extras', () => {
                ...
                it('includes: pineapple', () => {
                    expect(
                        oliviasMeal.extras.includes(extras.pineapple),
                    ).toEqual(true);
                });
                it('includes: mushrooms', () => {
                    expect(
                        oliviasMeal.extras.includes(extras.mushrooms),
                    ).toEqual(true);
                });
                it('includes: eggs', () => {
                    expect(oliviasMeal.extras.includes(extras.eggs)).toEqual(
                        true,
                    );
                });
                it('includes: broccoli', () => {
                    expect(
                        oliviasMeal.extras.includes(extras.broccoli),
                    ).toEqual(true);
                });
            });
        });
